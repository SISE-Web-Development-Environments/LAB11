...
- כפי שדיברנו בעבר, אפליקציית vue היא למעשה עץ היררכי של קומפוננטות
- vue-instace  הוא ה root component שלנו
- כאשר אנו משתמשים בקומפוננטה, בתוך קומפוננטה אחרת, אנו למעשה יוצרים child-component 
...
- לעומת זאת, קומפוננטות שהן למעשה רכיבים של עמוד, כמו קומפוננטת תצוגה מקדימה נרשום בתיקיית components.
...
שדה זה הינו אובייקט, אשר בתוכו נגדיר את כל השדות אותם אנו רוצים לקבל מקופוננטת האב


2. בtemplate, בתוך תגית הקומפוננטה בה אנו עושים שימוש, עבור כל שדה בprops  עלינו לספק ערך
...
*שימו לב - במידה וברצנוכם להעביר כמות גדולה של שדות, יש לשקול שליחה של אובייקט במקום שדות נפרדים.*
